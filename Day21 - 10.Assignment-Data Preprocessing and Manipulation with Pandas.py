'''
Assignment 10: Data Preprocessing and Manipulation with Pandas

Problem Statement:
You are provided with a DataFrame containing information about
daily weather conditions. Perform the following tasks:
